...
function chinese(Text) {
    return {
        'Issue Page': '��������',
        'Initialize Comments': '��ʼ�����ĵ�����ҳ',
        'Loading comments...': '��������...',
        'Error: Comments Not Initialized': '(δ��������)',
        'No Comment Yet': '(��û������)',
        'Previous': '��һҳ',
        'Next': '��һҳ',
        'Nothing to preview': '��û��Ԥ����',
        'Loading preview...': '����Ԥ��...',
        'Submitting...': '�����ύ����...',
        'Comment': '����',
        'Write': '����',
...
function chineseTraditional(Text) {
    return {
        'Issue Page': '�����uՓ',
        'Initialize Comments': '��ʼ�����ĵ��uՓ�',
        'Loading comments...': '���d�uՓ...',
        'Error: Comments Not Initialized': '(δ�_���uՓ)',
        'No Comment Yet': '(߀�]���uՓ)',
        'Previous': '��һ�',
        'Next': '��һ�',
        'Nothing to preview': '���]���A�[��',
        'Loading preview...': '���d�A�[...',
        'Submitting...': '�����ύ�uՓ...',
        'Comment': '�l��',
        'Write': '�uՓ',
        'Preview': '�A�[',
        'Logging in...': '������...',
        'Login to Comment': 'Ո�����԰l���uՓ',
        'Leave a comment': '(�l���uՓ)',
        'Login': '����',
        'Logout': '�ǳ�'
    }[Text] || Text;
}
